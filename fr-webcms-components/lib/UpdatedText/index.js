...
var UpdatedText = function (_Component) {
  _inherits(UpdatedText, _Component);
  ...
  function UpdatedText() {
    ...
    _classCallCheck(this, UpdatedText);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(UpdatedText)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleOnPress = function (event) {
      if (_this.props.onPress) _this.props.onPress(event);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(UpdatedText, [{
...
UpdatedText.contextTypes = {
  compTheme: object
};
exports.default = (0, _contextPure2.default)(UpdatedText);