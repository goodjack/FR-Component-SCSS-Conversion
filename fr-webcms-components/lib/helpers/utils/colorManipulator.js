...
exports.default = {
  ...
  _luminance: function _luminance(inputColor) {
    var color = this._decomposeColor(inputColor);

    var luminance = void 0;
    if (color.type.indexOf('rgb') > -1) {
      var rgb = color.values.map(function (value) {
        var val = value / 255; // normalized
  ...
  _convertHexToRGB: function _convertHexToRGB(inputColor) {
    var color = inputColor;
    if (color.length === 4) {
      var extendedColor = '#';
      for (var pos = 1; pos < color.length; pos++) {
  ...
  fade: function fade(colorIn, amount) {
    var color = colorIn;
  ...
  lighten: function lighten(colorIn, amount) {
    var color = this._decomposeColor(colorIn);
  ...
  darken: function darken(colorIn, amount) {
    var color = colorIn;
    color = this._decomposeColor(color);
