...
exports.default = {
  ...
  prepareStyles: function prepareStyles() {
    return _styles2.default.prepareStyles.apply(_styles2.default, [this.state && this.state.muiTheme || this.context && this.context.muiTheme].concat([].slice.apply(arguments)));
  }
};