...
var HeroVariationImageRight = function (_Component) {
  _inherits(HeroVariationImageRight, _Component);

  function HeroVariationImageRight() {
    var _Object$getPrototypeO;

    var _temp, _this, _ret;

    _classCallCheck(this, HeroVariationImageRight);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(HeroVariationImageRight)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      imageWidth: '100%',
      imageHeight: '100%'
  ...
  _createClass(HeroVariationImageRight, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { ref: 'heroImage', style: imgContainer },
  ...
  return HeroVariationImageRight;
}(_react.Component);
