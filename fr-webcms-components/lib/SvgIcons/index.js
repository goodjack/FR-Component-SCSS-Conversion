...
var _transitions = require('../helpers/styles/transitions');
...
var SvgIcon = _react2.default.createClass({
  ...
  getDefaultProps: function getDefaultProps() {
    var defaultMouseHandler = function defaultMouseHandler() {
      return null;
    };
  ...
  render: function render() {
    ...
    var offColor = style && style.fill ? style.fill : this.state.muiTheme.rawTheme.palette.textColor;
