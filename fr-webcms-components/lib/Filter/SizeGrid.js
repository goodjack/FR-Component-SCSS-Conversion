...
var SizeGrid = function (_Component) {
  _inherits(SizeGrid, _Component);
  ...
  function SizeGrid() {
    ...
    _classCallCheck(this, SizeGrid);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SizeGrid)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      gridIndex: []
      ...
      var dataIterate = _this.props.sizeData.split(',');
      var gridIndex = _this.state.gridIndex;


      var gridItem = dataIterate.map(function (data, index) {
        var bindCall = _this.setGridIndex.bind(_this, index);
        clickText = gridText;
  ...
  _createClass(SizeGrid, [{
    key: 'setGridIndex',
    value: function setGridIndex(index) {
      ...
      this.props.setSizeState(gridState, 'Size');
    }
  }, {
    key: 'render',
...
exports.default = (0, _contextPure2.default)(SizeGrid);