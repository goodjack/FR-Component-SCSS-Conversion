...
var prepareStyle = function prepareStyle(props, context) {
  ...
  var radioTheme = compTheme.radioButton || {};
  var labelRoot = {
    marginLeft: '10px',
    marginRight: '10px',
...
var RadioButton = function RadioButton(props, context) {
  ...
  return labelPosition && labelPosition.toUpperCase() === 'LEFT' ? _react2.default.createElement(
    'div',
    null,
    labelElement,
...
exports.default = (0, _contextPure2.default)(RadioButton);