...
import Transitions from '../helpers/styles/transitions';
...
const SvgIcon = React.createClass({
  ...
  getDefaultProps() {
    const defaultMouseHandler = () => null;

    return {
      onMouseEnter: defaultMouseHandler,
      onMouseLeave: defaultMouseHandler,
      viewBox: '0 0 24 24',
    };
  },
  ...
  getInitialState() {
    return {
      ...
      muiTheme: this.context.muiTheme ?
        this.context.muiTheme : ThemeManager.getMuiTheme(DefaultRawTheme),
    };
  },
  ...
  render() {
    ...
    let offColor = (style && style.fill) ?
      style.fill : this.state.muiTheme.rawTheme.palette.textColor;
    offColor = color ? color : offColor;
