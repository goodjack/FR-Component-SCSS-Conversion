...
const HomePage = React.createClass({
  ...
  _getHomePageHero() {
    let styles = {
      ...
      svgLogo: {
        marginLeft: window.innerWidth * 0.5 - 155,
        height: 157,
      },
      tagline: {
    ...
    return (
      <FullWidthSection style={styles.root}>
        <img style={styles.svgLogo} src="images/fr-logo.jpeg" />
        <div style={styles.tagline}>
          <h1 style={styles.h1}>Uniqlo Components</h1>
          <br/>
          <RaisedButton
  ...
  _onDemoClick() {
    this.history.pushState(null, '/get-started');
  },
