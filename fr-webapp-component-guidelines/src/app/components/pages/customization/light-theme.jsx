...
const DefaultRawTheme = Styles.defaultBaseTheme;

const LightThemePage = React.createClass({
  ...
  getInitialState() {
    return {
      ...
      compTheme: ThemeManager.getCompTheme(DefaultRawTheme),
    };
  },
  ...
  render() {
    ...
    return (
      <div>
        <h2 style={styles.headline}>Light Theme</h2>
